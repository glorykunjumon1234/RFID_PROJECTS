...
<?php
   ...
   $sql="SELECT * FROM tbl_data22";
       ...
       if($count1>0)
     {
       ...
       if($count>0){   
   		$msg="File Imported insert applcation no and then scan card to assign";
   ...
   <html>
      ...
      <body>
         ...
         <div class="container text-center" >
            ...
            <div class="row" >
               <div class="col">
                  <form class="form-horizontal" action="function.php" method="post" name="upload_excel" enctype="multipart/form-data">
                     <input type="file" name="file" id="file"><button type="submit" id="submit" name="submit" class="btn btn-info button-loading" data-loading-text="Loading...">Import</button></a>
                  </form>
               </div>
               <div class="col">
                  <form class="form-horizontal" action="exportID.php" method="post" name="export" enctype="multipart/form-data">
                     <div>      
                        <button type="submit" id="export" name="export" style="margin-left:95px" class="btn btn-info btn-cap my-1" data-loading-text="Loading...">Export File</button>
                  </form>
                  </div>
               </div>
               <div class="row" style="background-color:lightblue;">
                  <div class="col">
                     <div style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
            ...
            <div>
               <h2 align="center">For Manual registration - click below</h2>
            </div>
            <br>
            <div>
               <h3 align="center" id="blink"><font color="black"><a href="registration.php"> <span class="blink">Click here to Register</span></h3>
            </div>
         </div>
         <!-- /container -->	
      </body>
