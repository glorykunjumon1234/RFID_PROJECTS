...
<br>
 <form method="post">
  <div class="input-daterange">
   ...
   <tr><td>
  	<label>Ending    Date</label></td>
	<td><input type="date" name="toDate" class="form-control" value="<?php echo date("Y-m-d"); ?>"  />
	<?php echo $endDate; ?><br>
...
<!-- end of container -->
<br>
<div><h2 align="center">To import student's details  from csv file to mysql database - click below</h2>
	</div>
	<br>
<div><h3 align="center" id="blink"><font color="black"><a href="import1.php"> <span class="blink">Click here to Import</span></h3>
	</div>
<div class="row">
	<div class="col-md-8">
		<?php echo $noResult;?>
