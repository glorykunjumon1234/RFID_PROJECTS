     ...
     if(isset($_POST["submit"]))
     {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        ...
        if(!empty($filename))
        {
            ...
            $sql="INSERT INTO tbl_data22(name,appno,gender,department,graduation,mobile,date,pic) VALUES (?, ?,?, ?, ?, ?, ?,?)";
            $result=$conn->prepare($sql);
            
            $result->execute(array($name,$appno,$gender,$department,$graduation,$mobile,$date2,$pic));
